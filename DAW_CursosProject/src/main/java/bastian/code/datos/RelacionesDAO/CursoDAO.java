...
public class CursoDAO {
    ...
    // Obtiene los cursos del periodoActual
    public static ArrayList<CursoJB> select() {
        String query =  selectSQL + " where idPeriodo = " + PeriodoDAO.getPeriodoActual().getIdPeriodo();
